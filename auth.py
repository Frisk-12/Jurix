                    ...
                    if self.state.check_user:
                        ...
                        if button_s:
                            ...
                            with st.form("registration", border=False):
                                ...
                                Riconosco che l'uso di questo servizio è soggetto ai Termini di Utilizzo e alla Politica sulla Privacy di [Nome della tua azienda]. Accetto di conformarmi a tali termini e di rispettare le eventuali modifiche future. Comprendo inoltre che sono responsabile dell'uso sicuro delle mie credenziali di accesso e che sono tenuto a informare immediatamente [Nome della tua azienda] in caso di utilizzo non autorizzato del mio account.
        
                                Per ulteriori informazioni sui Termini di Utilizzo e sulla Politica sulla Privacy, posso consultare i relativi documenti disponibili sul sito web di [Nome della tua azienda].
                                """
